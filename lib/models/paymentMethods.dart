...
class PaymentMethodsData {
  ...
  PaymentMethodsData.fromJson(Map<String, dynamic> json) {
    ...
    midtransServerKey = json['midtrans_server_key'].toString();
    ...
    phonePayPaymentMethod = json['phonepay_payment_method'].toString();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['phonepay_payment_method'] = this.phonePayPaymentMethod;
    return data;
  }
}
